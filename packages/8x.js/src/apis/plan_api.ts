...
/**
  ...
  * A subscription plan is required in order to link a user's commitment with static on-chain payment plan which can't
...
export default class PlanAPI {
  ...
  */
   ...
   *    interval: 30,
   *    amount: 1000000000000000000, // Most token use 18 decimal places so this large amount translates to 10 tokens
   *    fee: 10000000000000000, // Similarly, this is actually 1/10 of a token
   *    data: '',
   *    name: 'Netflix',
   *    description: 'Premium plan',
   *    imageUrl: 'https://netflix.com/logo,
   *    terminationDate: 155324929, // (epoch in seconds),
   *    planHash: '0xd834n2k...'
   * }
   * ```
   *
