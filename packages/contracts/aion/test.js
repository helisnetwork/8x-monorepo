...
(async() => {
    try {
        let nameSol = fs.readFileSync("./flat/Executor_flat.sol", "utf8");
        ...
        const contractInst = new web3.eth.Contract(compiled.Executor.info.abiDefinition);
        const deploy = await contractInst.deploy( {data:compiled.Executor.code, arguments: []} ).encodeABI();
