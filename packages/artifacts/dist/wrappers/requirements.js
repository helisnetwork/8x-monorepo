...
var RequirementsContract = /** @class */ (function (_super) {
    __extends(RequirementsContract, _super);
    function RequirementsContract(web3ContractInstance, defaults) {
        ...
        _this.getStake = {
            callAsync: function (_gini, _divideBy, _startDate, _claimDate, _maximumClaimDate, _totalUnlocked, defaultBlock) {
                return __awaiter(this, void 0, void 0, function () {
                    var self, result;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, utils_1.promisify(self.web3ContractInstance.getStake.call, self.web3ContractInstance)(_gini, _divideBy, _startDate, _claimDate, _maximumClaimDate, _totalUnlocked)];
                            case 1:
                                result = _a.sent();
                                return [2 /*return*/, result];
                        }
    ...
    RequirementsContract.prototype.deploy = function () {
        var args = [];
    ...
    RequirementsContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var currentNetwork, abi, networks, web3ContractInstance;
            return __generator(this, function (_a) {
                currentNetwork = web3.version.network;
                abi = Requirements_1.Requirements.abi, networks = Requirements_1.Requirements.networks;
                web3ContractInstance = web3.eth.contract(abi).at(networks[currentNetwork].address);
                return [2 /*return*/, new RequirementsContract(web3ContractInstance, defaults)];
            });
        });
    };
    RequirementsContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            var abi, web3Utils, contractExists, currentNetwork, web3ContractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        abi = Requirements_1.Requirements.abi;
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            throw new Error(base_contract_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK('Requirements', currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
...
exports.RequirementsContract = RequirementsContract;
